...
C {sky130_fd_pr/cap_mim_m3_1.sym} 1830 -900 2 0 {name=C1 model=cap_mim_m3_1 W=32 L=30 MF=4 spiceprefix=X}
...
C {sky130_fd_pr/cap_mim_m3_2.sym} 1990 -900 0 0 {name=C2 model=cap_mim_m3_2 W=30 L=32 MF=4 spiceprefix=X}
