...
box 0um 0um 0um 0um
getcell ./../folded_cascode_n_in/folded_cascode_n_in.mag v child 0 0
shift_to_center
move 45um 22.7um

box -40um 22.5um -40um 22.5um
getcell sky130_fd_pr__cap_mim_m3_1_28umx28um.mag 90 child 0 0 

box 41um 22.5um 41um 22.5um 
getcell sky130_fd_pr__res_high_po_1p41_30um.mag child 0 0
box 44um 22.5um 44um 22.5um 
getcell sky130_fd_pr__res_high_po_1p41_30um.mag child 0 0

box 47um 22.5um 47um 22.5um 
getcell sky130_fd_pr__res_high_po_1p41_30um.mag child 0 0
...
#middle nmos
place_nmos 3 18 5 1 30 $fet_index 
set fet_index [expr $fet_index + 1]

#bottom nmos (imon output fet)
place_nmos 3 7.5 5 1 22 $fet_index 



set fet_index [expr $fet_index + 1]
#left pmos for driving sense fet
place_pmos -4 33.75 5 1 22 $fet_index

set fet_index [expr $fet_index + 1]

#right pmos for output mirror 
place_pmos 22 33.75 5 1 14 $fet_index



draw_pguard -22 0 35 25.5

draw_nguard -22 26.5 35 45

#guard cap 
draw_nguard -57 5 -23 45
