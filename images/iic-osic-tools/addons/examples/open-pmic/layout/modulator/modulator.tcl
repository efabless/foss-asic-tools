...
box 0um 0um 0um 0um
getcell comparator v child 0 0
shift_to_center
move 0um 22.7um

box 50um 17.5um 50um 17.5um
getcell sky130_fd_pr__res_high_po_1p41_20um.mag v child 0 0


#make cap (placeholder)
...
#wide pmos for islope
place_pmos 14 37 5 2 20 $fet_index 
set fet_index [expr $fet_index + 1]

#pmos for current offset mirrors
place_pmos 10 26 5 1 28 $fet_index 
set fet_index [expr $fet_index + 1]

#pmos for overcurrent
place_pmos 35 26 5 1 8 $fet_index 
set fet_index [expr $fet_index + 1]

#nmos for timeout 
place_nmos -2 10 5 1 10 $fet_index 
set fet_index [expr $fet_index + 1]

#current mirrors 
place_nmos 16.5 10 5 1 14 $fet_index 
set fet_index [expr $fet_index + 1]

#vcomp clamping
place_nmos_narrow 34 10 5 0.5 18 $fet_index 
...
draw_nguard -13 18.5 44.5 45

draw_pguard -13 0 44.5 18

#guard for poly resistor 
draw_pguard 45.5 0 55 36
