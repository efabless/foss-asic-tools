...
#middle nmos
place_nmos 0 -8 5 1 36 $fet_index 


set fet_index [expr $fet_index + 1]
#middle pmos
place_pmos 0 6 5 1 54 $fet_index

set fet_index [expr $fet_index + 1]

#top left pmos
place_pmos -15.48 15 5 1 16 $fet_index

set fet_index [expr $fet_index + 1]
#top right pmos
place_pmos 21.93 15 5 1 18 $fet_index
