...
load temp
#no clue why this
box 0.79um 0.79um 0.79um 0.79um  
getcell folded_cascode_p_in_stripped
shift_to_center
upsidedown
flatten folded_cascode_n_in
...
#middle nmos
place_pmos 0 8 5 1 36 $fet_index 


set fet_index [expr $fet_index + 1]
#middle pmos
place_nmos 0 -6.5 5 1 54 $fet_index

set fet_index [expr $fet_index + 1]

#top left pmos
place_nmos -15.48 -15 5 1 16 $fet_index

set fet_index [expr $fet_index + 1]
#top right pmos
place_nmos 21.93 -15 5 1 18 $fet_index
...
#import bias circuit 
box [expr $cell_ux + 0.79]um [expr $cell_ly + 0.79]um [expr $cell_ux + 0.79]um [expr $cell_ly + 0.79]um
getcell ./../bias-circuit/cascode_bias.mag
