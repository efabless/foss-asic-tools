...
S {}
E {}
T {OPAMP} 670 30 0 0 0.4 0.4 {}
T {dummy transistors} 1540 -630 0 0 0.4 0.4 {}
N 860 -210 880 -210 { lab=IN_P}
N 500 -210 520 -210 { lab=IN_M}
...
N 560 -180 560 -160 { lab=CM}
N 560 -160 820 -160 { lab=CM}
N 820 -180 820 -160 { lab=CM}
N 700 -160 700 -140 { lab=CM}
...
N 1140 -110 1280 -110 { lab=#net1}
N 1320 -170 1320 -140 { lab=#net2}
N 1100 -170 1100 -140 { lab=#net3}
N 1100 -400 1100 -230 { lab=#net1}
N 1320 -400 1320 -230 { lab=OUT}
N 1260 -200 1280 -200 { lab=VCN}
N 1140 -200 1160 -200 { lab=VCN}
N 1100 -260 1210 -260 { lab=#net1}
N 1210 -260 1210 -110 { lab=#net1}
...
N 460 -800 480 -800 { lab=VDD}
N 460 -760 480 -760 { lab=VSS}
N 760 -840 780 -840 { lab=VBN}
N 760 -800 780 -800 { lab=VCN}
N 760 -720 780 -720 { lab=VCP}
N 460 -700 480 -700 { lab=ibias}
N 1560 -470 1580 -470 { lab=VDD}
N 1560 -520 1560 -470 { lab=VDD}
N 1580 -520 1580 -500 { lab=VDD}
N 1560 -520 1580 -520 { lab=VDD}
N 1620 -470 1640 -470 { lab=VDD}
N 1640 -520 1640 -470 { lab=VDD}
N 1590 -520 1640 -520 { lab=VDD}
N 1580 -520 1590 -520 { lab=VDD}
N 1580 -440 1580 -420 { lab=VBP_INT}
N 1800 -440 1800 -400 { lab=VS1_P}
N 2060 -440 2060 -400 { lab=VS1_M}
N 1800 -520 1800 -500 { lab=VDD}
N 1780 -470 1800 -470 { lab=VDD}
N 1780 -520 1780 -470 { lab=VDD}
N 1840 -470 1860 -470 { lab=VDD}
N 1860 -520 1860 -470 { lab=VDD}
N 2060 -520 2060 -500 { lab=VDD}
N 2040 -470 2060 -470 { lab=VDD}
N 2040 -520 2040 -470 { lab=VDD}
N 2100 -470 2120 -470 { lab=VDD}
N 2120 -520 2120 -470 { lab=VDD}
N 1640 -520 2120 -520 { lab=VDD}
N 1340 -520 1560 -520 { lab=VDD}
N 1350 -40 1820 -40 { lab=VSS}
N 1820 -60 1820 -40 { lab=VSS}
N 1580 -60 1580 -40 { lab=VSS}
N 1800 -90 1820 -90 { lab=VSS}
N 1800 -90 1800 -40 { lab=VSS}
N 1560 -90 1580 -90 { lab=VSS}
N 1560 -90 1560 -40 { lab=VSS}
N 1620 -90 1620 -40 { lab=VSS}
N 1860 -90 1860 -40 { lab=VSS}
N 1820 -40 1860 -40 { lab=VSS}
N 2030 -90 2060 -90 { lab=VSS}
N 2030 -90 2030 -40 { lab=VSS}
N 1860 -40 2030 -40 { lab=VSS}
N 2060 -60 2060 -40 { lab=CM}
N 2060 -40 2130 -40 { lab=CM}
N 2130 -90 2130 -40 { lab=CM}
N 2100 -90 2130 -90 { lab=CM}
N 2060 -140 2060 -120 { lab=CM}
N 2060 -140 2130 -140 { lab=CM}
N 2130 -140 2130 -90 { lab=CM}
N 1560 -120 1580 -120 { lab=VSS}
N 1560 -120 1560 -90 { lab=VSS}
N 1820 -140 1820 -120 { lab=VBP_INT}
N 760 -760 780 -760 { lab=VBP}
N 1340 -40 1350 -40 { lab=VSS}
...
C {devices/lab_wire.sym} 880 -210 0 1 {name=l12 sig_type=std_logic lab=IN_P
}
C {devices/lab_wire.sym} 500 -210 0 0 {name=l13 sig_type=std_logic lab=IN_M}
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 400 -410 0 0 {name=M2
L=1
W=5
nf=1
mult=1
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 680 -410 0 0 {name=M6
L=1
W=5
nf=1
mult=1
...
C {cascode_bias.sym} 620 -780 0 0 {name=x1}
C {devices/lab_wire.sym} 460 -800 0 0 {name=l3 sig_type=std_logic lab=VDD
}
C {devices/lab_wire.sym} 460 -760 0 0 {name=l4 sig_type=std_logic lab=VSS
}
C {devices/lab_wire.sym} 780 -840 0 1 {name=l5 sig_type=std_logic lab=VBN
}
C {devices/lab_wire.sym} 780 -800 0 1 {name=l18 sig_type=std_logic lab=VCN

}
C {devices/lab_wire.sym} 780 -720 0 1 {name=l19 sig_type=std_logic lab=VCP

}
C {devices/lab_wire.sym} 460 -700 0 0 {name=l25 sig_type=std_logic lab=ibias
}
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 1600 -470 0 1 {name=M7
L=1
W=5
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 1820 -470 0 1 {name=M8
L=1
W=5
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 2080 -470 0 1 {name=M15
L=1
W=5
nf=1
mult=2
...
C {devices/lab_wire.sym} 1580 -420 0 1 {name=l26 sig_type=std_logic lab=VBP_INT}
C {devices/lab_wire.sym} 1800 -400 0 1 {name=l27 sig_type=std_logic lab=VS1_P

}
C {devices/lab_wire.sym} 2060 -400 0 1 {name=l28 sig_type=std_logic lab=VS1_M

}
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 1600 -90 0 1 {name=M16
L=1
W=5
nf=1
mult=2
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 1840 -90 0 1 {name=M20
L=1
W=5
nf=1
mult=2
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 2080 -90 0 1 {name=M21
L=1
W=5
nf=1
mult=2
...
C {devices/lab_wire.sym} 650 -160 0 1 {name=l29 sig_type=std_logic lab=CM
}
C {devices/lab_wire.sym} 2130 -140 0 1 {name=l30 sig_type=std_logic lab=CM
}
C {devices/lab_wire.sym} 1820 -140 0 1 {name=l31 sig_type=std_logic lab=VBP_INT}
C {devices/lab_wire.sym} 780 -760 0 1 {name=l32 sig_type=std_logic lab=VBP
